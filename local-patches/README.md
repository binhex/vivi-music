...
| The new strings are English only | The seven `download_folder_structure*` strings live in the default locale; every other locale falls back to English until translated. |
